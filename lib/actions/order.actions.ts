...
export async function approvePaystackOrder(
  orderId: string,
  data: { transaction: string, status: string },
  amount: number
) {
  await connectToDatabase();
  const session = await auth()
  ...
  try {
    ...
    // const re = {
    //   message: "Approved",
    //   redirecturl: "?trxref=T075326049734192&reference=T075326049734192",
    //   reference: "T075326049734192",
    //   status: "success",
    //   trans: "4756463371",
    //   transaction: "4756463371",
    //   trxref: "T075326049734192",
    // };
...
export const calcDeliveryDateAndPrice = async ({
  ...
  const taxPrice = !shippingAddress ? undefined : 0;
