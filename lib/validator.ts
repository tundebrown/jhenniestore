...
// Define allowed tags
const allowedTags = ["new-arrival", "todays-deal", "best-seller", "featured"];
...
export const ProductInputSchema = z.object({
  ...
  tags: z
    .string()
    .refine(
      (tag) => tag === "" || allowedTags.includes(tag), // Allow empty string or valid tag
      {
        message: `Tag must be one of: ${allowedTags.join(", ")}`,
      }
    )
